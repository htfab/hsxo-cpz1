...
set circuit1 [readnet spice ../netlist/layout/sky130_ht_ip__hsxo_cpz1.spice]
set circuit2 [readnet spice $hvlib]
readnet spice ../netlist/schematic/sky130_ht_ip__hsxo_cpz1.spice $circuit2

lvs "$circuit1 sky130_ht_ip__hsxo_cpz1" "$circuit2 sky130_ht_ip__hsxo_cpz1" \
	$setupfile sky130_ht_ip__hsxo_cpz1.out
